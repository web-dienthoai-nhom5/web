<?php include "header.php"?>
    <div class="container">
        <div class="g-container">
            <div class="l-pd-top">
                <h1 class="st-name"> Điện thoại Samsung Galaxy A34 128GB</h1>
        </div>
        <div class="l-pd-row">
        <table width=100%>
            <tr>
                    ...
                    <div class="l-pd-left">
                        <div class="st-slider fs-sale">
                            <div class="fs-sale-border">
                                <img src="https://cdn.tgdd.vn/Products/Images/42/298377/samsung-galaxy-a34-xanh-glr-1.jpg" alt="Samsung Galaxy A34 128GB">
                            </div>
                        </div>
                    </div>
                </td>
                        ...
                        <tr>
                            <td>
                                ...
                                <div class="st-price__left boxprice">
                                    <div class="st-pd-price" id="product-price-online"><h2>7.490.000đ</h2></div>
                                    <div class='st-pd-old-price'>
                                        <strike>8.490.000đ</strike>
                                    </div>
                                    <br>
                                </div>
                                <div class="promotion">
    ...
    $(document).ready(function () {
        ...
        $(".btn-muangay").on("click", function () {
            ...
            var productName = "Điện thoại Samsung Galaxy A34 128GB"; // You can replace this with dynamic data
    ...
    <div class="st-card">
        ...
        <table border="1"class="table-specs">
            ...
            <tr>
                <td>Kích thước</td>
                <td>Heigth: 161.3 mm - Width: 78.1 mm </td>
            </tr>
            <tr>
                <td>Trọng lượng</td>
                <td>199 g</td>
    ...
    <div class="renderboxbtn">
        <h2 class="card-title" style="text-align: center">Đặc điểm nổi bật</h2>
            <div class="card-body">
                <div  id='divText'>
                    <p  style="margin-bottom: 11px; text-align: justify;"><b>Thiết kế thu hút mọi góc nhìn với mặt lưng tráng gương cùng 3 gam màu hiện đại
                                                                            ...
                                                                            Cân mọi tác vụ với chip Dimensity 1080 kết hợp cùng RAM 8 GB và ROM 128 GB</b></p>
                    <p  style="margin-bottom: 11px; text-align: justify;"><img class='l-pd-left' alt="Điện thoại Samsung Galaxy A34 128GB" id="Điện thoại Samsung Galaxy A34 128GB" src="https://cdn.tgdd.vn/Products/Images/42/298377/samsung-galaxy-a34-xanh-glr-1.jpg" /></p>
                <div>
                    <br>
