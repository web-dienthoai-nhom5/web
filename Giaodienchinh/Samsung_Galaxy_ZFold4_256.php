<?php include "header.php"?>
    <div class="container">
        <div class="g-container">
            <div class="l-pd-top">
                <h1 class="st-name"> Điện thoại Samsung Galaxy Z Fold4 256GB</h1>
        </div>
        <div class="l-pd-row">
        <table width=100%>
            <tr>
                    ...
                    <div class="l-pd-left">
                        <div class="st-slider fs-sale">
                            <div class="fs-sale-border">
                                <img src="https://cdn.tgdd.vn/Products/Images/42/250625/samsung-galaxy-z-fold4-256gb-1.jpg" alt="Samsung Galaxy Z Fold4 256GB">
                            </div>
                        </div>
                    </div>
                </td>
                    ...
                    <td>
                        ...
                        <div class="card-body">
                            ...
                            <p  style="margin-bottom: 11px; text-align: justify;"><b>Camera mắt thần bóng đêm cho trải nghiệm chụp ảnh ấn tượng - Camera chính: 50MP
                                ...
                                <p  style="margin-bottom: 11px; text-align: justify;"><img class='l-pd-left' alt="Điện thoại Samsung Galaxy Z Fold4 256GB" id="Điện thoại Samsung Galaxy Z Fold 4 256GB" src="https://cdn.tgdd.vn/Products/Images/42/250625/samsung-galaxy-z-fold4-256gb-1.jpg" /></p>
                            </div> 
                        </div>
                    </td>           
    </div>
