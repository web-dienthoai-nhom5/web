<?php include "header.php"?>
    <div class="container">
        <div class="g-container">
            <div class="l-pd-top">
                <h1 class="st-name"> Điện thoại Samsung Galaxy A34 256GB</h1>
        </div>
        <div class="l-pd-row">
        <table width=100%>
            <tr>
                    ...
                    <div class="l-pd-left">
                        <div class="st-slider fs-sale">
                            <div class="fs-sale-border">
                                <img src="https://cdn.tgdd.vn/Products/Images/42/298377/samsung-galaxy-a34-den-1.jpg" alt="Samsung Galaxy A34 256GB">
                            </div>
                        </div>
                    </div>
                </td>
                        ...
                        <tr>
                            <td>
                                ...
                                <div class="st-price__left boxprice">
                                    <div class="st-pd-price" id="product-price-online"><h2>7.990.000đ</h2></div>
                                    <div class='st-pd-old-price'>
                                        <strike>9.490.000đ</strike>
                                    </div>
                                    <br>
                                </div>
                                <div class="promotion">
    ...
    $(document).ready(function () {
        ...
        $(".btn-muangay").on("click", function () {
            ...
            var productName = "Điện thoại Samsung Galaxy A34 256GB"; // You can replace this with dynamic data
