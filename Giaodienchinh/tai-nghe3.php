            ...
            <table width=100%>
                <tr>
                    <td>
                        ...
                        <div class="card-body">
                            <div  id='divText'>
                                <p  style="margin-bottom: 11px; text-align: justify;"><b>Kiểu dáng đơn giản, màu xanh lạ mắt, dễ mang theo 
                                                                                        <br> Sử dụng được với nhiều dòng điện thoại nhờ hỗ trợ jack 3.5 mm.
