<?php include "header.php"?>
    <div class="container">
        <div class="g-container">
            <div class="l-pd-top">
                <h1 class="st-name">Điện thoại Samsung Galaxy S23 5G 256GB</h1>
        </div>
        <div class="l-pd-row">
        <table width=100%>
            <tr>
                    ...
                    <div class="l-pd-left">
                        <div class="st-slider fs-sale">
                            <div class="fs-sale-border">
                                <img src="https://cdn.tgdd.vn/Products/Images/42/290829/samsung-galaxy-s23-plus-kem-1.jpg" alt="Samsung Galaxy S23 5G 256GB">
                            </div>
                        </div>
                    </div>
                </td>
                        ...
                        <tr>
                            <td>
                                ...
                                <div class="st-price__left boxprice">
                                    <div class="st-pd-price" id="product-price-online"><h2>19.990.000đ</h2></div>
                                    <div class='st-pd-old-price'>
                                        <strike>26.990.000đ</strike>
                                    </div>
                                    <br>
                                </div>
                                <div class="promotion">
    ...
    $(document).ready(function () {
        ...
        $(".btn-muangay").on("click", function () {
            ...
            var productName = "Điện thoại Samsung Galaxy S23 5G 256GB"; // You can replace this with dynamic data
        ...
        <h2 class="card-title" style="text-align: center">Đặc điểm nổi bật</h2>
            <div class="card-body">
                <div  id='divText'>
                    ...
                    <p  style="margin-bottom: 11px; text-align: justify;"><img class='l-pd-left' alt="Điện thoại Samsung Galaxy S23 5G 256GB" id="Điện thoại Samsung Galaxy S23 5G 256GB" src="https://cdn.tgdd.vn/Products/Images/42/290829/samsung-galaxy-s23-plus-kem-1.jpg" /></p>
                <div>
                    <br>
