                            ...
                            <div class="l-pd-left">
                                <div class="st-slider fs-sale">
                                    <div class="fs-sale-border">
                                        <img src="https://cdn.tgdd.vn/Products/Images/54/248455/samsung-galaxy-buds-2-r177n-trang-1.jpg" alt="border-detail">
                                    </div>
                            </div>
                        </div>
                        </td>
                                ...
                                <tr>
                                    <td>
                                        <div class="st-price__left boxprice">
                                            <div class="st-pd-price" id="product-price-online"><h2>2.800.000đ</h2></div>
                                            <div class='st-pd-old-price'>
                                                <strike  >2.990.000đ</strike>
                                            </div>
                                            <br>
                                        </div>
                                        <div class="promotion">
