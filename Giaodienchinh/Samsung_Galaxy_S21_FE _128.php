<?php include "header.php"?>
    <div class="container">
        <div class="g-container">
            <div class="l-pd-top">
                <h1 class="st-name">Điện thoại Samsung Galaxy S21 FE 5G (6GB/128GB)</h1>
        </div>
        <div class="l-pd-row">
        <table width=100%>
            <tr>
                    ...
                    <div class="l-pd-left">
                        <div class="st-slider fs-sale">
                            <div class="fs-sale-border">
                                <img src="https://cdn.tgdd.vn/Products/Images/42/267211/samsung-galaxy-s21-fe-1.jpg" alt="Samsung Galaxy S21 FE 5G (6GB/128GB)">
                            </div>
                        </div>
                    </div>
                </td>
    ...
    $(document).ready(function () {
        ...
        $(".btn-muangay").on("click", function () {
            ...
            var productName = "Điện thoại Samsung Galaxy S21 FE 5G (6GB/128GB)"; // You can replace this with dynamic data
        ...
        <h2 class="card-title" style="text-align: center">Đặc điểm nổi bật</h2>
            <div class="card-body">
                <div  id='divText'>
                    ...
                    <p  style="margin-bottom: 11px; text-align: justify;"><img class='l-pd-left' alt="Điện thoại Samsung Galaxy S21 FE 5G (6GB/128GB)" id="Điện thoại Samsung Galaxy S21 FE 5G (6GB/128GB)" src="https://cdn.tgdd.vn/Products/Images/42/267211/samsung-galaxy-s21-fe-1.jpg" /></p>
                <div>
                    <br>
