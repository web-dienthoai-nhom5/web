<?php include "header.php"?>
    ...
    <div class="sp">
        <br>
        <h3>Samsung Galaxy Z (Màn hình gập)</h3>
        <br>
        <table class="samsung_product">
            <tr>
                <td>   
                    <a href="http://localhost:8080/DoAn/Samsung_Galaxy_ZFlip4_128.php">
                    ...
                    <div class="discount-price"> 14.990.000đ</div>
                </td>
                <td>   
                    <a href="http://localhost:8080/DoAn/Samsung_Galaxy_ZFlip4_512.php">
                    ...
                    <div class="discount-price">15.490.000đ</div>
                </td>
                <td>
                    <a href="http://localhost:8080/DoAn/Samsung_Galaxy_ZFold4_256.php">
                    ...
                    <div class="discount-price"> 22.990.000đ</div>
                </td>    
                <td>
                    <a href="http://localhost:8080/DoAn/Samsung_Galaxy_ZFold4_512.php">
        ...
        <h3>Samsung Galaxy A</h3>
        <br>
        <table  class="samsung_product">
            <tr>
                <td>
                <a href="http://localhost:8080/DoAn/Samsung_Galaxy_A04s.php">
                    ...
                    <div class="discount-price">  3.190.000đ</div>
                </td>   
                <td>
                <a href="http://localhost:8080/DoAn/Samsung_Galaxy_A04.php">
                    ...
                    <div class="discount-price">  2.590.000đ</div>
                 </td> 
                <td>
                <a href="http://localhost:8080/DoAn/Samsung_Galaxy_A04_4.php">
                    ...
                    <div class="discount-price">  3.090.000đ</div>
                 </td>       
                <td>
                <a href="http://localhost:8080/DoAn/Samsung_Galaxy_A14_5.php">
                    ...
                    <div class="discount-price">  4.490.000đ</div>
                </td> 
            </tr>    
            <tr>
                <td>
                <a href="http://localhost:8080/DoAn/Samsung_Galaxy_A14_4.php">
                    ...
                    <div class="discount-price">  3.690.000đ</div>
                 </td> 
                <td>
                <a href="http://localhost:8080/DoAn/Samsung_Galaxy_A14_6.php">
                    ...
                    <div class="discount-price">  4.390.000đ</div>
                 </td> 
                <td>
                <a href="http://localhost:8080/DoAn/Samsung_Galaxy_A24_3.php">
                ...
                <a href="http://localhost:8080/DoAn/Samsung_Galaxy_A24_3.php">
                    ...
                    <div class="discount-price"> 6.390.000đ</div>
                </td>
            </tr>    
            <tr>
                <td>
                <a href="http://localhost:8080/DoAn/Samsung_Galaxy_A34_128.php">
                    ...
                    <div class="discount-price"> 7.490.000đ</div>
                </td>
                <td>
                <a href="http://localhost:8080/DoAn/Samsung_Galaxy_A34_256.php">
                    ...
                    <div class="discount-price"> 7.990.000đ</div>
                </td>
                <td>
                <a href="http://localhost:8080/DoAn/Samsung_Galaxy_A54_128.php">
                    ...
                    <div class="discount-price">  9.490.000đ</div>
                </td>
                <td>
                <a href="http://localhost:8080/DoAn/Samsung_Galaxy_A54_256.php">
                    ...
                    <div class="discount-price">  9.990.000đ</div>
                </td>
            </tr>  
        </table>   
        <br>    
        ...
        <table class="samsung_product">
            <tr>
                <td>   
                <a href="http://localhost:8080/DoAn/Samsung_Galaxy_S21_FE_128.php">
                ...
                <td>   
                <a href="http://localhost:8080/DoAn/Samsung_Galaxy_S21_FE_256.php">
                    ...
                    <div class="discount-price">  11.990.000đ</div>
                </td>
                <td>
                <a href="http://localhost:8080/DoAn/Samsung_Galaxy_S23_128.php">
                    ...
                    <div class="discount-price">  16.990.000đ</div>
                </td> 
                <td>
                <a href="http://localhost:8080/DoAn/Samsung_Galaxy_S23_256.php">
                    ...
                    <div class="discount-price">  19.990.000đ</div>
                </td> 
            </tr>    
            <tr>
                <td>
                <a href="http://localhost:8080/DoAn/Samsung_Galaxy_S23_512.php">
                ...
                <td>
                <a href="http://localhost:8080/DoAn/Samsung_Galaxy_S23_Ultra_256.php">
                    ...
                    <div class="discount-price">  23.990.000đ</div>
                </td>     
                <td>
                <a href="http://localhost:8080/DoAn/Samsung_Galaxy_S23_Ultra_512.php">
                    <img src="https://cdn.tgdd.vn/Products/Images/42/301796/samsung-galaxy-s23-ultra-kem-1-1.jpg" alt="" />
                    <figcaption>Điện thoại Samsung Galaxy S23 Ultra 5G 512GB</figcaption>
                    <div class="discount-price">  29.990.000đ</div>
                </td> 
                <td>
                <a href="http://localhost:8080/DoAn/Samsung_Galaxy_S23_Ultra_1TB.php">
                    <img src="https://cdn.tgdd.vn/Products/Images/42/301796/samsung-galaxy-s-ultra-tim-1.jpg" alt="" />
                    <figcaption>Điện thoại Samsung Galaxy S23 Ultra 5G 1TB</figcaption>
                    <div class="discount-price">  35.990.000đ</div>
                </td> 
            </tr> 
        </table>
        <br> 
