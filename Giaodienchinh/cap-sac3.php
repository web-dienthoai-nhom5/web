...
<?php include "header.php"?>
    ...
    <div class="container">
        ...
        <table border="0" cellpadding="2px"width="600px">
            <?php
                $result = mysqli_query($conn, "SELECT * FROM sanpham WHERE MASP=36") or die ("SELECT * FROM sanpham WHERE MASP=36" . "<br/><br/>" . mysqli_error($conn));
    ...
    <div class="g-container">
        <div class="st-card">
            ...
            <div class="renderboxbtn">
                        ...
                        <div class="card-body">
                            <div  id='divText'>
                                <p  style="margin-bottom: 11px; text-align: justify;"><b>Củ sạc Samsung 2 cổng 35W EP-TA210 - Phụ kiện thiết yếu cho người dùng Samsung
Củ sạc <br> của Samsung luôn được biết đến với chất lượng tốt cùng tốc độ sạc nhanh chóng. Nếu bạn đang <br> cần một củ sạc mới cho điện thoại Samsung hoặc bất kỳ thiết bị smartphone nào, hãy mua ngay <br> sản phẩm Củ sạc Samsung 2 cổng 35W EP-TA210.</b></p>
...
Trang bị dòng điện hiệu năng 25 Watt, củ sạc nhanh Samsung 25W USB-C sẽ đảm bảo điện thoại bạn có được thời lượng pin cao chỉ trong thời gian ngắn nhất. Và công nghệ Power Delivery tích hợp thêm sẽ càng tăng tốc quá trình sạc, đảm bảo bạn có điện thoại đầy pin mà không phải chờ đợi lâu.</p>
