...
<?php include "header.php"?>
    ...
    <div class="container">
        ...
        <table border="0" cellpadding="2px"width="600px">
            <?php
                $result = mysqli_query($conn, "SELECT * FROM sanpham WHERE MASP=5") or die ("SELECT * FROM sanpham WHERE MASP=5" . "<br/><br/>" . mysqli_error($conn));
            ...
            <table width=100%>
                <tr>
                    <td>
                        ...
                        <div class="card-body">
                            <div  id='divText'>
                                <p  style="margin-bottom: 11px; text-align: justify;"><b> Thiết kế ngoại hình mới mẻ, trẻ trung và hiện đại.
                                                                                        <br> Màn hình kích thước 6.5inch rộng rãi cùng tần số quét 90Hz mượt mà.
                                                                                        <br> Hệ thống camera có độ phân giải ấn tượng mang đến trải nghiệm chụp mãn nhãn ở nhiều góc độ.  
