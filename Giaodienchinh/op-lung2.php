<?php include "header.php"?>
    <div class="container">
        <div class="g-container">
            <div class="l-pd-top">
                <h1 class="st-name"> Ốp lưng Galaxy S23 FE Nhựa cứng PC Samsung Linh hoạt</h1>
        </div>
        <div class="l-pd-row">
            <table width=100%>
                    <tr>
                            ...
                            <div class="l-pd-left">
                                <div class="st-slider fs-sale">
                                    <div class="fs-sale-border">
                                        <img src="https://cdn.tgdd.vn/Products/Images/60/317090/op-lung-galaxy-s23-fe-nhua-cung-pc-samsung-linh-hoat-trong-1.jpg" alt="border-detail">
                                    </div>
                            </div>
                        </div>
                        </td>
                                ...
                                <tr>
                                    <td>
                                        <div class="st-price__left boxprice">
                                            <div class="st-pd-price" id="product-price-online"><h2>765.000đ</h2></div>
                                            <div class='st-pd-old-price'>
                                                <strike  >800.000đ</strike>
                                            </div>
                                            <br>
                                        </div>
                                        <div class="promotion">
    ...
    <div class="renderboxbtn">
                        ...
                        <div class="card-body">
                            <div  id='divText'>
                                <p  style="margin-bottom: 11px; text-align: justify;"><b> Ốp lưng Galaxy S23 FE có thiết kế trong suốt, phù hợp với mọi lứa tuổi sử dụng.
                                                                                         Tích hợp nhẫn đỡ ốp lưng, cho phép bạn cầm nắm điện thoại chắc chắn.
                                                                                         Được làm từ nhựa cứng bền bỉ, giúp bảo vệ điện thoại 1 cách tối ưu.
                                                                                         Hạn chế bám bụi, dấu vân tay, giữ cho Galaxy S23 FE của người dùng luôn mới.
                                                                                        Lưu ý: Thanh toán trước khi mở seal.</b></p>
                                <p  style="margin-bottom: 11px; text-align: justify;"><img class='l-pd-left' alt="Ốp lưng Galaxy S23 FE Nhựa cứng PC Samsung Linh hoạt" id="Ốp lưng Galaxy S23 FE Nhựa cứng PC Samsung Linh hoạt" 
                                src="https://cdn.tgdd.vn/Products/Images/60/317090/op-lung-galaxy-s23-fe-nhua-cung-pc-samsung-linh-hoat-trong-1.jpg" /></p>
                            </div>
                        </div> 
            ...
            divText.innerHTML += `
                <table>
                    <tr>
                        ...
                        <p style="margin-bottom: 11px; text-align: justify;">Cảm giác khi cầm hộp sạc rất vừa tay, nó nằm gọn trong lòng bàn tay mình. Khi mình sắm thêm một case đựng nữa thì đây chính là một combo hoàn hảo. Mình có thể thoải mái treo móc bất kỳ đâu,<br> balo hay túi xách đều được, hơn nữa còn bảo vệ dock sạc khỏi những vết xước hoặc dấu vân tay khi <br>sử dụng. Tất nhiên, nếu không có case đựng, bạn vẫn hoàn toàn dễ dàng cất giữ và mang theo vô cùng<br> thuận tiện.
