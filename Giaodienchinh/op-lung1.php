<?php include "header.php"?>
    <div class="container">
        <div class="g-container">
            <div class="l-pd-top">
                <h1 class="st-name"> Ốp lưng Galaxy Z Fold5 Nhựa cứng Samsung Linh hoạt</h1>
        </div>
        <div class="l-pd-row">
            <table width=100%>
                    <tr>
                            ...
                            <div class="l-pd-left">
                                <div class="st-slider fs-sale">
                                    <div class="fs-sale-border">
                                        <img src="https://cdn.tgdd.vn/Products/Images/60/312390/op-lung-galaxy-z-fold5-nhua-cung-samsung-linh-hoat-trong-5.jpg" alt="border-detail">
                                    </div>
                            </div>
                        </div>
                        </td>
                                ...
                                <tr>
                                    <td>
                                        <div class="st-price__left boxprice">
                                            <div class="st-pd-price" id="product-price-online"><h2>900.000đ</h2></div>
                                            <div class='st-pd-old-price'>
                                                <strike  >960.000đ</strike>
                                            </div>
                                            <br>
                                        </div>
                                        <div class="promotion">
    ...
    <div class="renderboxbtn">
                        ...
                        <div class="card-body">
                            <div  id='divText'>
                                <p  style="margin-bottom: 11px; text-align: justify;"><b> Ốp lưng Galaxy Z Fold5 Nhựa cứng Samsung Linh hoạt Chính hãng với thiết kế trong suốt, kiểu dáng tối giản, phù hợp với bất kì phiên bản màu sắc nào của Galaxy Z Fold5.
                                                                                         Ốp lưng được làm từ chất liệu nhựa cứng khá chắc chắn, hạn chế nứt vỡ hay trầy xước trong quá trình sử dụng, bảo vệ điện thoại.
                                                                                         Ốp lưng Samsung dễ dàng tháo lắp để vệ sinh máy, giữ thiết bị luôn trong tình trạng sạch sẽ.  
                                                                                         Sản phẩm chuyên dùng dành cho chiếc Galaxy Z Fold5.
                                                                                        Lưu ý: Thanh toán trước khi mở seal.</b></p>
                                <p  style="margin-bottom: 11px; text-align: justify;"><img class='l-pd-left' alt="Ốp lưng Galaxy Z Fold5 Nhựa cứng Samsung Linh hoạt" id="Ốp lưng Galaxy Z Fold5 Nhựa cứng Samsung Linh hoạt" src="https://cdn.tgdd.vn/Products/Images/60/312390/op-lung-galaxy-z-fold5-nhua-cung-samsung-linh-hoat-trong-5.jpg" /></p>
                            </div>
            ...
            divText.innerHTML += `
                <table>
                    <tr>
                        ...
                        <p style="margin-bottom: 11px; text-align: justify;">Cảm giác khi cầm hộp sạc rất vừa tay, nó nằm gọn trong lòng bàn tay mình. Khi mình sắm thêm một case đựng nữa thì đây chính là một combo hoàn hảo. Mình có thể thoải mái treo móc bất kỳ đâu,m balo hay túi xách đều được, hơn nữa còn bảo vệ dock sạc khỏi những vết xước hoặc dấu vân tay khi <br>sử dụng. Tất nhiên, nếu không có case đựng, bạn vẫn hoàn toàn dễ dàng cất giữ và mang theo vô cùng thuận tiện.
Khi mở hộp sạc ra, mình có thể dễ dàng mở bằng một tay và nó cho mình cảm giác phần bản lề chắc chắn, tiếng “tách” khi đóng hộp nghe khá vui tai.</p>
