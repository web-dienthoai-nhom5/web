<?php include "header.php"?>
                    ...
                    <div class="l-pd-left">
                        <div class="st-slider fs-sale">
                            <div class="fs-sale-border">
                                <img src="https://cdn.tgdd.vn/Products/Images/42/301796/samsung-galaxy-s-ultra-tim-1.jpg" alt="Samsung Galaxy S23 Ultra 5G 1TB">
                            </div>
                        </div>
                    </div>
                </td>
                        ...
                        <tr>
                            <td>
                                ...
                                <div class="st-price__left boxprice">
                                    <div class="st-pd-price" id="product-price-online"><h2>35.990.000đ</h2></div>
                                    <div class='st-pd-old-price'>
                                        <strike>44.990.000đ</strike>
                                    </div>
                                    <br>
                                </div>
                                <div class="promotion">
    ...
    $(document).ready(function () {
        ...
        $(".btn-muangay").on("click", function () {
            ...
            var productName = "Điện thoại Samsung Galaxy S23 Ultra 5G 1TB"; // You can replace this with dynamic data
