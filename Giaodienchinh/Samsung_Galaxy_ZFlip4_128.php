<?php include "header.php"?>
    <div class="container">
        <div class="g-container">
            <div class="l-pd-top">
                <h1 class="st-name"> Điện thoại Samsung Galaxy Z Flip4 128GB</h1>
        </div>
        <div class="l-pd-row">
        <table width=100%>
            <tr>
                    ...
                    <div class="l-pd-left">
                        <div class="st-slider fs-sale">
                            <div class="fs-sale-border">
                                <img src="https://cdn.tgdd.vn/Products/Images/42/258047/samsung-galaxy-flip4-glr-tim-1.jpg" alt="Samsung Galaxy Z Flip4 128GB">
                            </div>
                        </div>
                    </div>
                </td>
                        ...
                        <tr>
                            <td>
                                ...
                                <div class="st-price__left boxprice">
                                    <div class="st-pd-price" id="product-price-online"><h2>14.990.000đ</h2></div>
                                    <div class='st-pd-old-price'>
                                        <strike>23.990.000đ</strike>
                                    </div>
                                    <br>
                                </div>
                                <div class="promotion">
                    ...
                    <td>
                        ...
                        <div class="card-body">
                            ...
                            <p  style="margin-bottom: 11px; text-align: justify;"><b> Ngoại hình thời trang - cầm nắm cực sang với thiết kế gập vỏ sò độc đáo
                                ...
                                <p  style="margin-bottom: 11px; text-align: justify;"><img class='l-pd-left' alt="Điện thoại Samsung Galaxy Z Flip4 128GB" id="Điện thoại Samsung Galaxy Z Flip4 128GB" src="https://cdn.tgdd.vn/Products/Images/42/258047/samsung-galaxy-flip4-glr-tim-1.jpg" /></p>
                            </div> 
                        </div>
                    </td>           
    </div>
