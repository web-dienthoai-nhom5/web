...
<?php include "header.php"?>
    ...
    <div class="container">
        <div class="g-container">
            <div class="l-pd-top">
                <h1 class="st-name"> Củ sạc nhanh Samsung 25W không kèm cáp (EP-T2510NBEGWW) </h1>
                <br>
        </div>
        <table border="0" cellpadding="2px"width="600px">
            <?php
                $result = mysqli_query($conn, "SELECT * FROM sanpham WHERE MASP=37") or die ("SELECT * FROM sanpham WHERE MASP=37" . "<br/><br/>" . mysqli_error($conn));
    ...
    <div class="st-card">
            ...
            <div class="renderboxbtn">
                        ...
                        <div class="card-body">
                            <div  id='divText'>
                                <p  style="margin-bottom: 11px; text-align: justify;"><b>Củ sạc nhanh Samsung 25W không kèm cáp (EP-T2510NBEGWW) - Phụ kiện thiết yếu cho người dùng Samsung
Củ sạc <br> của Samsung luôn được biết đến với chất lượng tốt cùng tốc độ sạc nhanh chóng. Nếu bạn đang <br> cần một củ sạc mới cho điện thoại Samsung hoặc bất kỳ thiết bị smartphone nào, hãy mua ngay <br> sản phẩm Củ sạc nhanh Samsung 25W không kèm cáp (EP-T2510NBEGWW).</b></p>
        ...
        them2.addEventListener("click", function() {
            initial.innerHTML += `
                <table>
                    ...
                    <tr>
                        <td>Model</td>
                        <td>Củ sạc nhanh Samsung 25W không kèm cáp (EP-T2510NBEGWW)</td>
                    </tr>
                    <tr>
                        <td>Hãng sản xuất</td>
