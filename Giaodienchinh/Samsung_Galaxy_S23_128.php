...
<?php include "header.php"?>
    ...
    <div class="st-card">
        ...
        <table border="1"class="table-specs">
            ...
            <tr>
                <td>Kích thước</td>
                <td>Height: 146.3 mm - Width: 70.9 mm </td>
            </tr>
            <tr>
                <td>Trọng lượng</td>
                <td>168 g</td>
        ...
        <h2 class="card-title" style="text-align: center">Đặc điểm nổi bật</h2>
            <div class="card-body">
                <div  id='divText'>
                    ...
                    <p  style="margin-bottom: 11px; text-align: justify;"><img class='l-pd-left' alt="Điện thoại Samsung Galaxy S23 5G 128GB" id="Điện thoại Samsung Galaxy S23 5G 128GB" src="https://cdn.tgdd.vn/Products/Images/42/264060/samsung-galaxy-s23-den-1-1.jpg" /></p>
                <div>
                    <br>
