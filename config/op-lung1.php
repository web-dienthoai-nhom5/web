...
<body>
    ...
    <div class="row">
        <ol class="breadcrumb breadcrumb-margin">
            ...
            <li class="breadcrumb-item"><a href="op-lung.php" onClick="gaSendEvent('Product Detail', 'Click Breadcrumb', 'Phụ kiện');">Ốp lưng</a></li>
        </ol>
    </div>
    <div class="container">
                        ...
                        <div class="card-body">
                            <div  id='divText'>
                                <p  style="margin-bottom: 11px; text-align: justify;"><b> Ốp lưng Galaxy Z Fold5 Nhựa cứng Samsung Linh hoạt Chính hãng với thiết kế trong suốt, kiểu dáng tối giản, phù hợp với bất kì phiên bản màu sắc nào của Galaxy Z Fold5.
                                                                                        <br> Ốp lưng được làm từ chất liệu nhựa cứng khá chắc chắn, hạn chế nứt vỡ hay trầy xước trong quá trình sử dụng, bảo vệ điện thoại.
                                                                                        <br> Ốp lưng Samsung dễ dàng tháo lắp để vệ sinh máy, giữ thiết bị luôn trong tình trạng sạch sẽ.  
                                                                                        <br> Sản phẩm chuyên dùng dành cho chiếc Galaxy Z Fold5.
