                            ...
                            <div class="l-pd-left">
                                <div class="st-slider fs-sale">
                                    <div class="fs-sale-border">
                                        <img src="../../img/phukien/hinhdt (1).jpg" alt="border-detail">
                                    </div>
                            </div>
                        </div>
                        </td>
            ...
            <table width=100%>
                <tr>
                    <td>
                        ...
                        <div class="card-body">
                            <div  id='divText'>
                                <p  style="margin-bottom: 11px; text-align: justify;"><b>Thiết kế gọn nhẹ, màu sắc sang chảnh.Điều mình chú ý đầu tiên chính là tổng quan thiết kế <br> của bộ tai nghe này, toàn bộ hộp sạc và tai nghe đều được bao phủ bởi màu trắng trang nhã,<br> thanh lịch. Phần logo Samsung in ở mặt trên hộp sạc càng làm thiết kế trở nên tinh tế hơn. Với <br>mình, đây không chỉ là một chiếc tai nghe mà nó còn là một món phụ kiện thời trang sang chảnh.</b></p>
                                <p  style="margin-bottom: 11px; text-align: justify;"><img class='l-pd-left' alt="Tai nghe có dây Samsung IA500 3.5mm 1" id="Tai nghe có dây Samsung IA500 3.5mm 11" src="https://cdn.tgdd.vn/Products/Images/54/286045/tai-nghe-bluetooth-true-wireless-galaxy-buds2-pro-151022-035748.jpg" /></p>
                            </div> 
                        </div>
                    </td>
                    <td>
