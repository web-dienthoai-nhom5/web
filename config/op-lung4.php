                            ...
                            <div class="l-pd-left">
                                <div class="st-slider fs-sale">
                                    <div class="fs-sale-border">
                                        <img src="https://cdn.tgdd.vn/Products/Images/60/317088/op-lung-galaxy-s23-fe-silicone-samsung-xanh-mint-1.jpg" alt="border-detail">
                                    </div>
                            </div>
                        </div>
                        </td>
                                ...
                                <tr>
                                    <td>
                                        <div class="st-price__left boxprice">
                                            <div class="st-pd-price" id="product-price-online"><h2>670.000đ</h2></div>
                        ...
                        <div class="card-body">
                            <div  id='divText'>
                                <p  style="margin-bottom: 11px; text-align: justify;"><b> Kiểu dáng ốp lưng sang trọng, gam màu cá tính, trẻ trung.
                                                                                        <br> Chất liệu ốp lưng được làm bằng silicone mỏng nhẹ, giảm thiểu nứt vỡ trong quá trình sử dụng.
                                                                                        <br> Ốp lưng Galaxy S23 FE dễ dàng lắp vào và tháo ra.
                                                                                        <br> Thiết kế ốp lưng Samsung hoàn toàn vừa vặn với thân máy, tăng cường bảo vệ cho chiếc Galaxy S23 FE.                                                                    
