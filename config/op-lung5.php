...
<body>
    ...
    <div class="container">
        <div class="g-container">
            <div class="l-pd-top">
                <h1 class="st-name"> Bao da Galaxy S23 FE Samsung Thông minh</h1>
        </div>
        <div class="l-pd-row">
            <table width=100%>
                    <tr>
                            ...
                            <div class="l-pd-left">
                                <div class="st-slider fs-sale">
                                    <div class="fs-sale-border">
                                        <img src="https://cdn.tgdd.vn/Products/Images/60/317085/bao-da-galaxy-s23-fe-samsung-thong-minh-trang-1.jpg" alt="border-detail">
                                    </div>
                            </div>
                        </div>
                        </td>
                                ...
                                <tr>
                                    <td>
                                        <div class="st-price__left boxprice">
                                            <div class="st-pd-price" id="product-price-online"><h2>989.000đ</h2></div>
            ...
            <table width=100%>
                <tr>
                    <td>
                        ...
                        <div class="card-body">
                            <div  id='divText'>
                                <p  style="margin-bottom: 11px; text-align: justify;"><b> Bao da Galaxy S23 FE sở hữu thiết kế tinh tế với gam màu trắng thanh lịch.
                                                                                        <br> Được làm từ chất liệu da cao cấp, hỗ trợ cầm nắm êm tay, hạn chế bám dính mồ hôi tay trong quá trình sử dụng.
                                                                                        <br> Bao da có ô hiển thị màn hình nhỏ, hỗ trợ người dùng xem thông báo, cuộc gọi,... tiện lợi.
                                                                                        <br> Thiết kế kèm ngăn đựng thẻ bên trong, giúp bạn bảo vệ thẻ cùng điện thoại Galaxy S23 FE an toàn.                                                                   
                                                                                        <br> Lưu ý: Thanh toán trước khi mở seal.</b></p>
                                <p  style="margin-bottom: 11px; text-align: justify;"><img class='l-pd-left' alt="Bao da Galaxy S23 FE Samsung Thông minh" id="Bao da Galaxy S23 FE Samsung Thông minh" 
                                src="https://cdn.tgdd.vn/Products/Images/60/317085/bao-da-galaxy-s23-fe-samsung-thong-minh-trang-1.jpg" /></p>
                            </div> 
                        </div>
                    </td>           
    </div>
