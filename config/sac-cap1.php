...
<html lang="vi">
<head>
<title>Củ sạc Samsung USB-C 25W 1 cổng</title>
<meta charset="UTF-8">
...
<body>
    ...
    <div class="container">
        <div class="g-container">
            <div class="l-pd-top">
                <h1 class="st-name">Củ sạc Samsung USB-C 25W 1 cổng</h1>
        </div>
        <div class="l-pd-row">
            <table width=100%>
                    <tr>
                            ...
                            <div class="l-pd-left">
                                <div class="st-slider fs-sale">
                                    <div class="fs-sale-border">
                                        <img src="../../img/phukien/group_205_2.webp" alt="border-detail">
                                    </div>
                            </div>
                        </div>
                        </td>
                                ...
                                <tr>
                                    <td>
                                        <div class="st-price__left boxprice">
                                            <div class="st-pd-price" id="product-price-online"><h2>250.000đ</h2></div>
                                            <div class='st-pd-old-price'>
                                                <strike >499.000đđ</strike>
                                            </div>
                                            <br>
                                        </div>
                                        <div class="promotion">
        ...
        them2.addEventListener("click", function() {
            initial.innerHTML += `
                <table>
                    ...
                    <tr>
                        <td>Model</td>
                        <td>Củ sạc Samsung USB-C 25W 1 cổng</td>
                    </tr>
                    <tr>
                        <td>Hãng sản xuất</td>
