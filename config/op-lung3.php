...
<body>
    ...
    <div class="container">
        <div class="g-container">
            <div class="l-pd-top">
                <h1 class="st-name"> Ốp lưng Galaxy M54 5G Nhựa cứng viền dẻo Pure II JM</h1>
        </div>
        <div class="l-pd-row">
            <table width=100%>
                    <tr>
                            ...
                            <div class="l-pd-left">
                                <div class="st-slider fs-sale">
                                    <div class="fs-sale-border">
                                        <img src="https://cdn.tgdd.vn/Products/Images/60/317218/op-lung-galaxy-m54-5g-nhua-cung-vien-deo-pure-ii-jm-1.jpg" alt="border-detail">
                                    </div>
                            </div>
                        </div>
                        </td>
                                ...
                                <tr>
                                    <td>
                                        <div class="st-price__left boxprice">
                                            <div class="st-pd-price" id="product-price-online"><h2>185.000đ</h2></div>
            ...
            <table width=100%>
                <tr>
                    <td>
                        ...
                        <div class="card-body">
                            <div  id='divText'>
                                <p  style="margin-bottom: 11px; text-align: justify;"><b> Ốp lưng Galaxy M54 sở hữu kiểu dáng tối giản, phù hợp với mọi phong cách sử dụng.
                                                                                        <br> Ốp lưng mỏng nhẹ, không ảnh hưởng đến thiết kế nguyên bản của Galaxy M54 5G.
                                                                                        <br> Mặt lưng được làm từ chất liệu nhựa cứng bền bỉ, kết hợp cùng viền dẻo có độ đàn hồi cao, dễ dàng tháo lắp                                                                    
                                                                                        <br> Ốp lưng JM giúp hạn chế bám dấu vân tay, hay bụi bẩn, giữ cho điện thoại luôn như mới.</b></p>
                                <p  style="margin-bottom: 11px; text-align: justify;"><img class='l-pd-left' alt="Ốp lưng Galaxy M54 5G Nhựa cứng viền dẻo Pure II JM" id="Ốp lưng Galaxy M54 5G Nhựa cứng viền dẻo Pure II JM" 
                                src="https://cdn.tgdd.vn/Products/Images/60/317218/op-lung-galaxy-m54-5g-nhua-cung-vien-deo-pure-ii-jm-1.jpg" /></p>
                            </div> 
                        </div>
                    </td>           
    </div>
